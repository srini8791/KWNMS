...
/**
 * Keywest packet which is used as a protocol or transerring data from KW device to NMS/APP
 * @author Spittala
 *
 */
public class KeywestPacket {
	...
	protected KeywestLTVPacket getLTVFromPacket() {
		...
		// from 3rd byte to payload length retreive the remaining payload (length (2 bytes) + type (1 byte))
