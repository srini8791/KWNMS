 ...
 */
public final class KWPSystemGroup extends AggregateTracker {
    private static final Logger LOG = LoggerFactory.getLogger(KWPSystemGroup.class);

    //
    // Lookup strings for specific table entries
    //
    /** Constant <code>SYS_OBJECTID_ALIAS="sysObjectID"</code> */
    public static final String KWP_SYS_INFO_NAME_ALIAS = " sysInfoName";
    private static final String  KWP_SYS_INFO_NAME = ".1.3.6.1.4.1.52619.1.2.2.1";
    ...
    public static final String KWP_SYS_INFO_LOCATION_ALIAS = "sysInfoLocation";
    private static final String KWP_SYS_INFO_LOCATION = ".1.3.6.1.4.1.52619.1.2.2.2";

    /** Constant <code>SYS_NAME_ALIAS="sysName"</code> */
    public static final String SYS_INFO_CONTACT_ALIAS = "sysInfoContact";
    private static final String SYS_INFO_CONTACT = " .1.3.6.1.4.1.52619.1.2.2.3";

    /** Constant <code>SYS_DESCR_ALIAS="sysDescr"</code> */
    public static final String SYS_DESCR_ALIAS = "sysInfoDescription";
    private static final String SYS_DESCR = ".1.3.6.1.4.1.52619.1.2.2.4";

    /** Constant <code>SYS_LOCATION_ALIAS="sysLocation"</code> */
    public static final String SYS_GEO_LATITUDE_ALIAS = "sysInfoGeolat";
    private static final String SYS_GEO_LATITUDE = ".1.3.6.1.4.1.52619.1.2.2.5";

    /** Constant <code>SYS_CONTACT_ALIAS="sysContact"</code> */
    public static final String SYS_GEO_LONGITUDE_ALIAS = "sysInfoGeolong";
    private static final String SYS_GEO_LONGITUDE = ".1.3.6.1.4.1.52619.1.2.2.6";
    /**
     * <P>
    ...
    static {
         ...
         * </P>
         */
        ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, KWP_SYS_INFO_NAME_ALIAS, KWP_SYS_INFO_NAME);
         ...
         * </P>
         */
        ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, KWP_SYS_INFO_LOCATION_ALIAS, KWP_SYS_INFO_LOCATION);
         ...
         * </P>
         */
        ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_INFO_CONTACT_ALIAS, SYS_INFO_CONTACT);
         ...
         * </P>
         */
        ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_GEO_LATITUDE_ALIAS, SYS_GEO_LATITUDE);
         ...
         * </P>
         */
        ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_GEO_LONGITUDE_ALIAS, SYS_GEO_LONGITUDE);
     ...
     * @param address TODO
     */
    public KWPSystemGroup(InetAddress address) {
    ...
    public String getSysName() {
        return m_store.getDisplayString(KWP_SYS_INFO_NAME);
    }
     ...
     * @return a {@link String} object.
     */
    public String getSysGeoLongitude() {
        return m_store.getDisplayString(SYS_GEO_LONGITUDE);
    }
     ...
     * @return a {@link String} object.
     */
    public String getSysGeoLatitude() {
        return m_store.getDisplayString(SYS_GEO_LATITUDE);
    }
    ...
    public String getSysContact() {
        return m_store.getDisplayString(SYS_INFO_CONTACT);
    }
     ...
     * @return a {@link String} object.
     */
    public String getKwpSysInfoLocation() {
        return m_store.getDisplayString(KWP_SYS_INFO_LOCATION);
    }
    ...
    public void updateSnmpDataForResource(ScanResource sr) {
        if (!failed()) {
            ...
            sr.setAttribute("sysLocation", getKwpSysInfoLocation());
            sr.setAttribute("sysObjectId", getSysObjectID());
            sr.setAttribute("latitude",getSysGeoLatitude());
            sr.setAttribute("longitude",getSysGeoLongitude());
