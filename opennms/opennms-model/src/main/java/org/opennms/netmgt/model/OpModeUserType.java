...
public class OpModeUserType extends EnumType {
    ...
    public Object nullSafeGet(final ResultSet rs, final String[] names, final Object owner) throws HibernateException, SQLException {
        ...
        throw new HibernateException("Invalid value for OpMode: " + c);
    }
    ...
    @Override
    public Class<OpMode> returnedClass() {
        return OpMode.class;
    }
