...
<jsp:include page="/includes/bootstrap.jsp" flush="false" >
  <jsp:param name="title" value="Syslog Event List" />
  <jsp:param name="headTitle" value="Syslog Events" />
  <jsp:param name="headTitle" value="Events" />
  <jsp:param name="breadcrumb" value="<a href= 'event/syslog' title='Syslog Events System Page'>Events</a>" />
  <jsp:param name="breadcrumb" value="Syslog Events" />
</jsp:include>
  ...
  <script type="text/javascript">
    ...
    function changeFavorite(favoriteId, filter) {
        window.location.href = "<%=req.getContextPath()%>/event/syslog?favoriteId=" + favoriteId + '&' + filter;
    }
  </script>
...
<%!
    final String urlBase = "event/syslog";
