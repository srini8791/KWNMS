    ...
    <div class="col-md-12">
        <div class="col-sm-12 col-md-2">
            <div class="panel panel-stats">
                ...
                <div class="panel-body">
                    <span class="stats stats-total">477</span>
                </div>
            </div>            
        </div>
        <div class="col-sm-12 col-md-2">
            <div class="panel panel-stats">
                <div class="panel-heading">
                    <h3 class="panel-title">BSU</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3">Active</div>
                        <div class="col-md-3">Down</div>
                        <div class="col-md-6">Provisioned</div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 stats stats-active">40</div>
                        <div class="col-md-3 stats stats-down">20</div>
                        <div class="col-md-6 stats stats-prov">28</div>
                    </div>
                </div>
            </div>            
        </div>
        <div class="col-sm-12 col-md-2">
            <div class="panel panel-stats">
                <div class="panel-heading">
                    <h3 class="panel-title">SU</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3">Up</div>
                        <div class="col-md-3">Down</div>
                        <div class="col-md-6">Provisioned</div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 stats stats-active">60</div>
                        <div class="col-md-3 stats stats-down">40</div>
                        <div class="col-md-6 stats stats-prov">48</div>
                    </div>
                </div>
            </div>            
        </div>
        <div class="col-sm-12 col-md-2">
            <div class="panel panel-stats">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 stats stats-up">80</div>
                        <div class="col-md-3 stats stats-down">60</div>
                        <div class="col-md-6 stats stats-prov">64</div>
                    </div>
                </div>
            </div>            
        </div>
        <div class="col-sm-12 col-md-2">
            <div class="panel panel-stats">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 stats stats-up">20</div>
                        <div class="col-md-3 stats stats-down">6</div>
                        <div class="col-md-6 stats stats-prov">11</div>
                    </div>
                </div>
            </div>            
        </div>
