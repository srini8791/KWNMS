...
public class ProfileRestService extends AbstractDaoRestService<OnmsProfile, SearchBean, Integer, String> {
    ...
    private List<String> buildPropsToWrite(OnmsProfile profile) {
        ...
        OpMode profileOpMode = profile.getOpMode();
        Bandwidth profileBandwidth = profile.getBandwidth();
        Integer profileChannel = profile.getChannel();
